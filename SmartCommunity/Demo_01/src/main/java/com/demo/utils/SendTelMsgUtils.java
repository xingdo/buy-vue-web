...
public class SendTelMsgUtils {
     ...
     */
    public static final String ACCOUNT_SID = "b773c960d9b34f399700908d037abd8a";


    /**
     * AUTH_TOKEN:开发者账号认证密匙(注册后自动生成)
     */
    public static final String AUTH_TOKEN = "d50ea3b5f55f464e88bd3ba8ef1d4741";
    ...
    public static String sendMsgTo(String to, String createRandNum) {
         ...
         */
        String smsContent = "【东方科技】您的验证码为" + randNum + "，请于2分钟内正确输入，如非本人操作，请忽略此短信。";
    ...
    public static String sig_MD5(String str) {
        String sig_md5 = DigestUtils.md5DigestAsHex(str.getBytes());
        return sig_md5;
    }
        public static void main(String[] args){
            String randNum = PhoneNumUtil.getRandom();
            System.out.println("验证码是：" + randNum);
            // randNum发送给手机号
            String result = SendTelMsgUtils.sendMsgTo("13594171524", randNum);
